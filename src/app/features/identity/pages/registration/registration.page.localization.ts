export class RegistrationPageLocalization {
    static USERNAME_EMAIL_LABEL_PLACEHOLDER = $localize`:@@feature.identity.registration.page.username-email.label-placeholder:Username or Email`;
    static PASSWORD_LABEL_PLACEHOLDER = $localize`:@@feature.identity.registration.page.password.label-placeholder:Password`;
    static CONFIRM_PASSWORD_LABEL_PLACEHOLDER = $localize`:@@feature.identity.registration.page.confirm-password.label-placeholder:Password`;
