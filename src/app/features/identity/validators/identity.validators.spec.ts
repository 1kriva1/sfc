...
describe('Features.Identity:Validators', () => {
    ...
    describe('UserNameEmail validator', () => {
        fit('Should be invalid', () => {
            const testValue = 'username#',
                validationResult = IdentityValidators.userNameEmail(new UntypedFormControl(testValue)),
    ...
    describe('UserNameEmail exist validator', () => {
        fit('Should show loader', fakeAsync(() => {
            ...
            const testValue = 'test@email.com',
                ...
                validationResult = IdentityValidators.userNameEmailExist(existenceServiceStub as any, loaderServiceStub as any, controlId)
